...
async function main() {
    ...
    const instructions = {
      ...
      <p>
      If you are uncertain about where the ball will go, we would like you to reflect that in the spread of your predictions - for example, in the video below, it might be unclear whether the ball would bounce after teleporting, and so half of the clicks were on the left side of the block, and the other half were on the right side.
    ...
    let predictAndProbe = {
        timeline: [
            ...
            },
            {
                timeline: [
                    {
                        ...
                        stimulus: () => {
                            ...
                            let probe_obj = jsPsych.timelineVariable("probe_obj");

                            let stim_idx = worldtype == "1" ? entry_color_idx : 1 - entry_color_idx;
                            _STATE.probe_img = jsPsych.timelineVariable("color" + stim_idx + "_probe_img" + i);
                            console.log("probe_img", _STATE.probe_img);
                            ...
                            _STATE.answer = 1 - i;
                            _STATE.i = i;
                            // console.log("answer", 1 - i, i == 1 ? "A" : "B");
                            return `
              <p>
              ...
              <img src=${_STATE.probe_img} style='width:100%'/>
              </div>
              </div>
              `;
                        },
                        on_finish: (data) => {
                            ...
                            data.counterbalance_id = _STATE.i;
                        },
                        data: () => {
                            let out = {};
