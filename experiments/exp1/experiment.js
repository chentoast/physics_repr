        ...
        timeline: [
                ...
                on_load: () => {
                    ...
                    c.addEventListener("click", (e) => {
                        ...
                        if (_STATE.clickPositions.length == 10) {
                            _STATE.totalTime =
                                new Date().getTime() - _STATE.trialBeginTime;
                            jsPsych.finishTrial();
                        }
                    });
            ...
            },
            {
                ...
                stimulus: () => {
                    ...
                    let out = [];
                    let clickPositions =
                        jsPsych.data.getLastTrialData().trials[0]
                            .clickPositions;
            ...
            },
            {
                timeline: [
                    {
                        ...
                        stimulus: () => {
                            if (Math.random() < 0.5) {
                                _STATE.base = jsPsych.timelineVariable("baseImgRed");
                                _STATE.modified =
                                    jsPsych.timelineVariable("modifiedImgBlue");
                                _STATE.answer = 0;
                            } else {
                                _STATE.base = jsPsych.timelineVariable("baseImgBlue");
                                _STATE.modified =
                                    jsPsych.timelineVariable("modifiedImgRed");
                                _STATE.answer = 1;
                            }
                            return `
              <p>
              Pop quiz: in the below image, one of the highlighted shapes was in the correct position, while another was in the incorrect position. Which color object was in the <b>correct, original</b> position? Please select a choice using the slider below.
              </p>
              ...
              <img src=${_STATE.modified} style='position:absolute;top:0;left:0;opacity:.5'>
              </div>
              </div>
              `;
                        },
                        on_finish: (data) => {
                            ...
                            data.baseImg = _STATE.baseImg;
                            data.modifiedImg = _STATE.modifiedImg;
                        },
                        data: {
                            world: jsPsych.timelineVariable("world"),
                            worldType: jsPsych.timelineVariable("worldType"),
                        ...
                        // choices: ["red", "blue"],
                        labels: ["Absolutely sure it was red", "Not sure at all", "Absolutely sure it was blue"],
          ...
          <source src=${video}>
                ...
                on_load: () => {
                    let button =
                        document.getElementsByClassName("jspsych-btn")[0];
