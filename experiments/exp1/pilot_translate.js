...
let _DEBUG = false; // don't show filler trials
        ...
        timeline: [
            ...
            },
            {
                timeline: [
                    {
                        ...
                        stimulus: () => {
                            ...
                            return `
              <p>
              Pop quiz: in the below image, one of the highlighted shape was in the correct position, another was in the incorrect position. Which color object was in the <b>correct, original</b> position? Please select a choice, and also indicate how
              ...
              `;
                        ...
                        choices: ["red", "blue"],
                        labels: ["not at all sure", "very sure"],
