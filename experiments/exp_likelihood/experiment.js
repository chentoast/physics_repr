...
async function main() {
    ...
    let stimuli = jsPsych.randomization.shuffle(targetStimuli);
        ...
        timeline: [
            ...
            },
            {
                ...
                stimulus: () => {
                    ...
                    return `
              <p>
              Pop quiz: in the below image, an object is highlighted. How likely do you think it is that the ball will hit the object? Please express your answer
              using the slider below, where 0 indicates that you are absolutely certain that the ball will never hit the object, and 100 indicates that you are
              certain that the ball will hit the object.
              </p>
